package chapter7oopprimary.VariableScope;
...
class Cat {
    ...
    public void localVarParam() {
        ...
        // 如果没有else就会在编译期报错.所以局部变量未初始化不会出现在运行阶段
        else {
            localVarParam = 10;
        }
        System.out.println(localVarParam);

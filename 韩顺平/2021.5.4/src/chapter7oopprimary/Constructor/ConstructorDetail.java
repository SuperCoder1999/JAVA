package chapter7oopprimary.Constructor;
...
public class ConstructorDetail {
    public static void main(String[] args) {
        ...
        //7. 一旦定义了自己的构造器，默认的构造器就被覆盖，就不能再使用默认无参构造器
            // 除非显式地定义一下
        //8.本类中的非构造器方法不能调用本类及父类构造器，构造器方法可以通过this(参数)调用任意构造器,甚至是自己调用自己
        //9.子类的构造器方法通过super(参数)调用父类构造器

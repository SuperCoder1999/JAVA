...
/*
    ...
    反汇编代码 Compiled from "KeywordEnumIntroduce.java":
...
public class KeywordEnumIntroduce {
    ...
    public static void main(String[] args) {
        ...
        //调用enum类实现接口的方法
        Tiger.TIGER.say();
        System.out.println(Tiger.TIGER01.getClass().getName());
        System.out.println(Tiger.TIGER.getClass().getName());
    }
}

package chapter25jdbc.frame.apache_dbutils.resultset_toarraylist;
...
/**
 * 使用老师的土方法来解决ResultSet在connect关闭后,就取不出数据的缺陷
 * 将resultSet内容 转存到Arraylist中
 */
...
public class ResultSetToArrayList {
    ...
    //使用老师的土方法来解决ResultSet缺陷 =封装=> Arraylist

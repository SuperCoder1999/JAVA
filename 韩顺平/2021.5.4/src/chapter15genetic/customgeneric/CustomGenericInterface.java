...
/*
    ...
    3. 如果在继承或实现时没有指定类型，默认为Object，但是建议直接写成 IUsb<Object,Object>
...
//接口泛型还能使用被实现类的类泛型赋值 或 被子接口的接口泛型赋值
class EE<T, Y> implements IUsb<T, Y> {

    @Override
    public Y get(T integer) {
        return null;
    }

    @Override
    public void hi(Y aFloat) {

    }

    @Override
    public void run(Y r1, Y r2, T u1, T u2) {
